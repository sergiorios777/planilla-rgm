...
func (r *CtsRepository) CrearLiquidacionCese(l *models.LiquidacionCese) error {
	query := `
		INSERT INTO liquidaciones_cese (
			...
			monto_vacaciones_truncas, monto_gratificacion_trunca, total_liquidacion, estado
	...
	return r.db.QueryRow(query,
		...
		l.MontoVacacionesTruncas, l.MontoGratiTrunca, l.TotalLiquidacion, l.Estado,
	).Scan(&l.ID, &l.CreatedAt, &l.UpdatedAt)
}

// ObtenerLiquidacionCesePorID recupera una liquidación de cese por ID
func (r *CtsRepository) ObtenerLiquidacionCesePorID(id int, tenantID int) (*models.LiquidacionCese, error) {
	query := `
		SELECT l.id, l.tenant_id, l.contrato_id, l.fecha_inicio_computable, l.fecha_cese, l.motivo,
		       ...
		       l.monto_vacaciones_truncas, l.monto_gratificacion_trunca, l.total_liquidacion, l.estado,
...
func (r *CtsRepository) ListarLiquidacionesCese(tenantID int) ([]models.LiquidacionCese, error) {
	query := `
		SELECT l.id, l.tenant_id, l.contrato_id, l.fecha_inicio_computable, l.fecha_cese, l.motivo,
		       l.anos_servicios, l.meses_servicios, l.remuneracion_computable, l.monto_cts,
		       l.monto_vacaciones_truncas, l.monto_gratificacion_trunca, l.total_liquidacion, l.estado,
...
func (r *CtsRepository) EliminarLiquidacionCese(id int, tenantID int) error {
