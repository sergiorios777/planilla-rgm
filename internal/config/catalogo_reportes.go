...
var ListaReportes = []models.Reporte{
	...
	{ID: "concepto_maestro", Modulo: "CONCEPTOS", Nombre: "Catálogo Local de Conceptos", Descripcion: "Lista de ingresos y aportes configurados con sus afectaciones de ley y clasificadores MEF."},
	{ID: "contrato_vence", Modulo: "CONTRATOS", Nombre: "Alertas de Vencimiento de Contrato", Descripcion: "Contratos de personal a plazo fijo o transitorios CAS próximos a culminar en el rango de días especificado."},
}
